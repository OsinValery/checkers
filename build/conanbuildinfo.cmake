...
###  DOXYGEN
#################
set(CONAN_DOXYGEN_ROOT "/Users/valerij/.conan/data/doxygen/1.8.20/_/_/package/2d36ef93f4aac51333b231bcccb770deba4580d7")
set(CONAN_INCLUDE_DIRS_DOXYGEN )
set(CONAN_LIB_DIRS_DOXYGEN )
set(CONAN_BIN_DIRS_DOXYGEN "/Users/valerij/.conan/data/doxygen/1.8.20/_/_/package/2d36ef93f4aac51333b231bcccb770deba4580d7/bin")
set(CONAN_RES_DIRS_DOXYGEN )
set(CONAN_SRC_DIRS_DOXYGEN )
set(CONAN_BUILD_DIRS_DOXYGEN "/Users/valerij/.conan/data/doxygen/1.8.20/_/_/package/2d36ef93f4aac51333b231bcccb770deba4580d7/")
...
set(CONAN_SYSTEM_LIBS_XAPIAN-CORE )
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_DOXYGEN_DEPENDENCIES "${CONAN_SYSTEM_LIBS_DOXYGEN} ${CONAN_FRAMEWORKS_FOUND_DOXYGEN} CONAN_PKG::xapian-core CONAN_PKG::zlib")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_DOXYGEN}" "${CONAN_LIB_DIRS_DOXYGEN}"
                                  ...
                                  "" doxygen)
    set(_CONAN_PKG_LIBS_DOXYGEN_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_DOXYGEN_DEBUG} ${CONAN_FRAMEWORKS_FOUND_DOXYGEN_DEBUG} CONAN_PKG::xapian-core CONAN_PKG::zlib")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_DOXYGEN_DEBUG}" "${CONAN_LIB_DIRS_DOXYGEN_DEBUG}"
                                  ...
                                  "debug" doxygen)
    set(_CONAN_PKG_LIBS_DOXYGEN_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_DOXYGEN_RELEASE} ${CONAN_FRAMEWORKS_FOUND_DOXYGEN_RELEASE} CONAN_PKG::xapian-core CONAN_PKG::zlib")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_DOXYGEN_RELEASE}" "${CONAN_LIB_DIRS_DOXYGEN_RELEASE}"
                                  ...
                                  "release" doxygen)
    set(_CONAN_PKG_LIBS_DOXYGEN_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_DOXYGEN_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_DOXYGEN_RELWITHDEBINFO} CONAN_PKG::xapian-core CONAN_PKG::zlib")
    ...
    set(_CONAN_PKG_LIBS_DOXYGEN_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_DOXYGEN_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_DOXYGEN_MINSIZEREL} CONAN_PKG::xapian-core CONAN_PKG::zlib")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_XAPIAN-CORE}" "${CONAN_LIB_DIRS_XAPIAN-CORE}"
                                  ...
                                  "" xapian-core)
    set(_CONAN_PKG_LIBS_XAPIAN-CORE_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_XAPIAN-CORE_DEBUG} ${CONAN_FRAMEWORKS_FOUND_XAPIAN-CORE_DEBUG} CONAN_PKG::libuuid CONAN_PKG::zlib")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_XAPIAN-CORE_DEBUG}" "${CONAN_LIB_DIRS_XAPIAN-CORE_DEBUG}"
                                  ...
                                  "debug" xapian-core)
    set(_CONAN_PKG_LIBS_XAPIAN-CORE_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_XAPIAN-CORE_RELEASE} ${CONAN_FRAMEWORKS_FOUND_XAPIAN-CORE_RELEASE} CONAN_PKG::libuuid CONAN_PKG::zlib")
    ...
    conan_package_library_targets("${CONAN_PKG_LIBS_XAPIAN-CORE_RELEASE}" "${CONAN_LIB_DIRS_XAPIAN-CORE_RELEASE}"
                                  ...
                                  "release" xapian-core)
    set(_CONAN_PKG_LIBS_XAPIAN-CORE_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_XAPIAN-CORE_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_XAPIAN-CORE_RELWITHDEBINFO} CONAN_PKG::libuuid CONAN_PKG::zlib")
    ...
    set(_CONAN_PKG_LIBS_XAPIAN-CORE_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_XAPIAN-CORE_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_XAPIAN-CORE_MINSIZEREL} CONAN_PKG::libuuid CONAN_PKG::zlib")
